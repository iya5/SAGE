...
void main()
{
     ...
     */
    vec3 normal = normalize(mat3(transpose(inverse(u_model))) * attr_normal);
    /* Ambient: 
     *      ka * ki 
     */
     ...
     *      kd * (Lm * N) * imd
     */
    vec3 light_direction = normalize(u_light.pos - attr_pos);
     ...
     */
    vec3 view_direction = normalize(u_view_pos - attr_pos);
